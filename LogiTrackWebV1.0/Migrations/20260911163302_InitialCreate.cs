        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shipping_Street = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Shipping_Building = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteCheckpoints_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentRoute_mtm", x => new { x.ShipmentId, x.StationId });
                    table.ForeignKey(
                        name: "FK_ShipmentRoute_mtm_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipmentRoute_mtm_Stations_StationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteCheckpoints_ShipmentId",
                table: "RouteCheckpoints",
                column: "ShipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentRoute_mtm_StationId",
                table: "ShipmentRoute_mtm",
                column: "StationId");
